...
var MyFavoriteTemplateComponent = (function() {
    function MyFavoriteTemplateComponent(settingsStorage, wordDocument, wordTemplateApiService) {
    ...
    MyFavoriteTemplateComponent.prototype.ngAfterViewInit = function() {
        var _this = this;
    ...
    // }
    MyFavoriteTemplateComponent.prototype.applyTemplate = function(template) {
        this.wordDocument.setOoxml(template.templateContent);
    };
    MyFavoriteTemplateComponent.prototype.addOrganization = function(template) {
        var _this = this;
    ...
    MyFavoriteTemplateComponent.prototype.closeMessage = function() {
        this.message = "";
        this.isShowMessage = false;
    };
    MyFavoriteTemplateComponent = __decorate([
        core_1.Component({
    ...
    return MyFavoriteTemplateComponent;
}());
exports.MyFavoriteTemplateComponent = MyFavoriteTemplateComponent;
//# sourceMappingURL=my-favorite-template.component.js.map